...
{{-- Charte Driply (app iOS) : crème #F5F0E8, or #C9A96E, texte #2C2622 / #8C7B6B --}}
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:520px;background-color:#EDE8DE;border-radius:16px;border:1px solid #DDD5C4;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:8px 28px 24px 28px;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
                            ...
                            @endif
                            <p style="margin:0 0 24px 0;font-size:15px;line-height:1.6;color:#8C7B6B;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
                                <tr>
                                    <td align="center" style="border-radius:12px;background-color:#2C2622;">
                                        <a href="{{ $verificationUrl }}" target="_blank" rel="noopener" style="display:inline-block;padding:14px 28px;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:600;color:#F5F0E8;text-decoration:none;border-radius:12px;">
                                            {{ __('Verify Email Address') }}
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:20px 0 0 0;font-size:12px;line-height:1.5;color:#8C7B6B;word-break:break-all;">
                                ...
                                <a href="{{ $verificationUrl }}" style="color:#8C6B3D;text-decoration:underline;">{{ $verificationUrl }}</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
